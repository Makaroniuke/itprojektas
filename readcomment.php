    ...
    <div class="d-flex justify-content-center row">
        <div class="col-md-8">
            <div class="d-flex flex-column comment-section">
				...
				$sql = "SELECT Komentaras.laikas, Komentaras.komentaras, users.username FROM Komentaras INNER join users
				ON Komentaras.autorius_id = users.userid
				Inner join Fotografija ON Fotografija.id = Komentaras.fotografija_id
				Where Fotografija.id = '$id'";
